...
def query(ctx_config):
    ...
    try:
        ...
        print(nextlinuxcli.cli.utils.format_error_output(config, "query", {}, err))
        sys.exit(2)
...
def images_by_vulnerability(
    ...
    try:
        ret = nextlinuxcli.clients.apiexternal.query_images_by_vulnerability(
            config,
            vulnerability_id,
            namespace=namespace,
...
def images_by_package(name, version, package_type):
    ...
    try:
        ret = nextlinuxcli.clients.apiexternal.query_images_by_package(
