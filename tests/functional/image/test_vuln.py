...
skip_versions = [
    "nextlinux/inline-scan:v0.6.0",
    "nextlinux/inline-scan:v0.5.0",
    "nextlinux/inline-scan:v0.5.1",
]

skip_reason = "Github Advisories not available in this version of Nextlinux Engine"
...
class TestNonOsVulnerabilities:
    ...
    def stdout(self, class_admin_call):
        ...
        """
        # XXX This needs to point to an nextlinux image
